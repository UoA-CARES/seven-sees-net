...
def train_one_epoch(epoch_index, interval=5):
    ...
    for i, (_, _, _, _, _, depth, _, _, targets)  in enumerate(train_loader):
...
def validate():
    ...
    with torch.inference_mode():
        for i, (_, _, _, _, _, depth, _, _, vtargets)  in enumerate(test_loader):
...
if __name__ == '__main__':
    ...
    # Configs
    work_dir = 'work_dirs/seven-seas-v1-depth/'
    batch_size = 256
